...
export default {
  type: 'sliceBands',
  label: 'SLICE_BANDS',
  desc: 'El encuadre se divide en bandas paralelas y cada banda muestra un frame distinto del pasado (slit-scan). ÁNGULO rota las bandas; FEATHER funde los bordes.',
  params: [
    { key: 'bands',   label: 'BANDAS',    min: 2, max: 64, step: 1, def: 12 },
    { key: 'offset',  label: 'OFFSET (f)', min: 0, max: 150, step: 1, def: 30,
      help: 'Retraso máximo, en frames, de la banda más antigua.' },
    { key: 'jitter',  label: 'JITTER',    min: 0, max: 1, step: 0.01, def: 0.15,
      help: 'Desorden aleatorio del retraso de cada banda.' },
    ...
    { key: 'feather', label: 'FEATHER',   min: 0, max: 0.5, step: 0.01, def: 0.05,
      help: 'Fundido alfa entre bandas vecinas (0 = corte duro).' },
    { key: 'seed',    label: 'SEED',      min: 0, max: 100, step: 1, def: 1,
      help: 'Semilla del patrón aleatorio: cambia la combinación sin cambiar el carácter.' },
  ],
  presets: {
