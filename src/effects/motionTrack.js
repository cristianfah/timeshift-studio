...
export default {
  type: 'motionTrack',
  label: 'MOTION_TRACK',
  desc: 'Detecta movimiento real y lo marca con cajas, líneas y valores, como un tracker de laboratorio. Colócalo al final de la cadena.',
  params: [
    { key: 'sensitivity', label: 'SENSIBILIDAD', min: 0.02, max: 0.5, step: 0.01, def: 0.10,
      help: 'Umbral de cambio entre frames para considerar movimiento. Bajo = detecta más.' },
    ...
    { key: 'smoothing',   label: 'SUAVIZADO', min: 0, max: 0.95, step: 0.01, def: 0.65,
      help: 'Suaviza la posición de las cajas entre frames.' },
    { key: 'persistence', label: 'PERSISTENCIA (f)', min: 1, max: 40, step: 1, def: 10,
      help: 'Frames que una caja sobrevive sin detección (sigue por inercia).' },
